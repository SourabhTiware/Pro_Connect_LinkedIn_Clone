...
export const deletePost = createAsyncThunk("post/deletePost", async ( post_id, thunkAPI ) =>{
...
export const incrementPostLike = createAsyncThunk("post/incrementLike", async(post, thunkAPI) =>{
  ...
  async ({ post_id, commentBody }, thunkAPI) => {
    try {
      ...
      if (!token || !post_id || !commentBody) {
        return thunkAPI.rejectWithValue("Token, post_id and commentBody are required");
      }
